...
static void init_thread(struct thread *, char const *name, int priority);
...
tid_t thread_create(char const *name, int priority, thread_func *function, void *aux)
{
	struct thread *t;
...
/* Does basic initialization of T as a blocked thread named
  NAME. */
static void init_thread(struct thread *t, char const *name, int priority)
{
	enum intr_level old_level;
