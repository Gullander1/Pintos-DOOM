...
/* Writes to PORT each byte of data in the CNT-byte buffer
  starting at ADDR. */
static inline void outsb(uint16_t port, void const *addr, size_t cnt)
{
	/* See [IA32-v2b] "OUTS". */
...
static inline void outsw(uint16_t port, void const *addr, size_t cnt)
{
	/* See [IA32-v2b] "OUTS". */
...
static inline void outsl(uint16_t port, void const *addr, size_t cnt)
{
	/* See [IA32-v2b] "OUTS". */
