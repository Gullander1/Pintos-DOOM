...
char const *block_type_name(enum block_type);
...
void block_write(struct block *, block_sector_t, void const *);
char const *block_name(struct block *);
...
struct block_operations {
	...
	void (*write)(void *aux, block_sector_t, void const *buffer);
};
