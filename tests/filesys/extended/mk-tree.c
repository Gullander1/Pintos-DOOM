...
static void do_mkdir(char const *format, ...) PRINTF_FORMAT(1, 2);
static void do_touch(char const *format, ...) PRINTF_FORMAT(1, 2);
...
static void do_mkdir(char const *format, ...)
{
	char dir[128];
	va_list args;
...
static void do_touch(char const *format, ...)
{
	char file[128];
	va_list args;
