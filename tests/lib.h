...
void msg(char const *, ...) PRINTF_FORMAT(1, 2);
void fail(char const *, ...) PRINTF_FORMAT(1, 2) NO_RETURN;
...
void check_file_handle(int fd, char const *file_name, void const *buf_, size_t filesize);
void check_file(char const *file_name, void const *buf, size_t filesize);
