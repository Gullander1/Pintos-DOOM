...
static int compare_ints(void const *, void const *);
static void verify_order(int const[], size_t);
static void verify_bsearch(int const[], size_t);
...
static int compare_ints(void const *a_, void const *b_)
{
	int const *a = a_;
	int const *b = b_;
...
static void verify_order(int const *array, size_t cnt)
{
	int i;
...
static void verify_bsearch(int const *array, size_t cnt)
{
