...
static int const EXPECTED_DEPTH_TO_PASS = 30;
static int const EXPECTED_REPETITIONS = 10;
...
static int NO_INLINE consume_some_resources_and_die(int seed)
{
	...
	random_init(seed);
	int volatile *PHYS_BASE = (int volatile *) 0xC0000000;
