...
unsigned hash_bytes(void const *buf_, size_t size)
{
	/* Fowler-Noll-Vo 32-bit hash, for bytes. */
	unsigned char const *buf = buf_;
	unsigned hash;
...
unsigned hash_string(char const *s_)
{
	unsigned char const *s = (unsigned char const *) s_;
	unsigned hash;
