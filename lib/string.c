...
/* Copies SIZE bytes from SRC to DST, which must not overlap.
  Returns DST. */
void *memcpy(void *dst_, void const *src_, size_t size)
{
...
/* Copies SIZE bytes from SRC to DST, which are allowed to
  overlap.  Returns DST. */
void *memmove(void *dst_, void const *src_, size_t size)
{
	unsigned char *dst = dst_;
	unsigned char const *src = src_;
...
int memcmp(void const *a_, void const *b_, size_t size)
{
...
/* Finds the first differing characters in strings A and B.
  ...
  equal. */
int strcmp(char const *a_, char const *b_)
{
	unsigned char const *a = (unsigned char const *) a_;
	unsigned char const *b = (unsigned char const *) b_;
...
void *memchr(void const *block_, int ch_, size_t size)
{
	unsigned char const *block = block_;
...
/* Finds and returns the first occurrence of C in STRING, or a
  ...
  STRING. */
char *strchr(char const *string, int c_)
{
	char c = c_;
...
size_t strcspn(char const *string, char const *stop)
{
	size_t length;
...
/* Returns a pointer to the first character in STRING that is
  ...
  null pointer. */
char *strpbrk(char const *string, char const *stop)
{
	for (; *string != '\0'; string++) {
...
char *strrchr(char const *string, int c_)
{
	char c = c_;
	char const *p = NULL;
...
size_t strspn(char const *string, char const *skip)
{
	size_t length;
...
/* Breaks a string into tokens separated by DELIMITERS.  The
  ...
  outputs:
    ...
    'tokenize.'
*/
char *strtok_r(char *s, char const *delimiters, char **save_ptr)
{
	char *token;
...
size_t strnlen(char const *string, size_t maxlen)
{
	size_t length;
